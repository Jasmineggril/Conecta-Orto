...
const PLACEHOLDER_ITEMS: GalleryItem[] = [
  ...
  {
    id: 10,
    imageUrl: "https://www.projectaeventos.com.br/imagens/categorias/evento-academico-cientifico-02.webp",
    title: "Equipe organizadora",
    caption: "UnDF — Conecta Orto 2026",
    altText: "Equipe do evento acadêmico-científico",
    category: "equipe",
    displayOrder: 10,
  },
  {
    id: 11,
    imageUrl: "https://www.projectaeventos.com.br/imagens/categorias/organizacao-evento-cientifico-01.webp",
    title: "Bastidores",
    caption: "Preparação antes do evento",
    altText: "Organização de evento científico",
    category: "equipe",
    displayOrder: 11,
  },
  /* ── ENCERRAMENTO ── */
